...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="flex justify-between mb-5">
            <div>
                <h2 class="mb-2 text-2xl tracking-tight font-bold text-gray-500 dark:text-white">Utilisateurs</h2>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <img class="w-10 h-10 rounded-full" src="{{asset("profil/$user->photo")}}" alt="photo {{$user->name}}">
                                <div class="ps-3">
                            ...
                            <td class="px-6 py-4">
                                <button data-modal-target="edit-user-modal-{{$user->id}}" data-modal-toggle="edit-user-modal-{{$user->id}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mx-1">Modifier</button>
