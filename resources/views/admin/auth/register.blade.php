    ...
    <div class="box-forms max-w-md max-h-full ms-5 ">
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                ...
                <form class="space-y-4" action="{{route('admin.auth.register')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Déjà un compte? <a href="{{route('admin.auth.login.form')}}" class="text-blue-700 hover:underline dark:text-blue-500">Se connecter</a>
                    </div>
