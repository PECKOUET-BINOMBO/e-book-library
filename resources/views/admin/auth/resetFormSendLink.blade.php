...
<div class="bg-white content relative flex items-center justify-center">
    <div class="box-video ">
        <video autoplay loop muted class="w-full h-full object-cover">
            <source src="{{asset('/videos/Library3.mp4')}}" type='video/mp4'>
        </video>
    </div>
    <div class="box-forms max-w-md max-h-full ms-5 ">
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex flex-col items-center justify-center p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <p class="text-xs text-gray-500 font-normal">Entrez votre email pour recevoir un lien de réinitialisation</p>

            </div>
            <!-- Modal body -->
            <div class="p-4 md:p-5">

                <form class="space-y-4" action="{{route('resetSendLink')}}" method="POST">
                    @csrf
                    <div>
                    ...
                    <p class="text-center text-gray-500">Retour à la<a class="text-blue-500" href="{{route('auth.login.form')}}"> connexion</a></p>
                </form>
            </div>
        </div>
    </div>
